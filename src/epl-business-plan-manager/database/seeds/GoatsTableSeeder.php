    ...
    public function run()
    {
        DB::table('goats')->insert(array(
            ...
            array('type' => 'A', 'parent_id' => 6, 
                ...
                'priority' => 2, 'due_date' => Carbon\Carbon::now() , 'budget' => 10000, 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()),
    		
            array('type' => 'A', 'parent_id' => 6, 
                'description' => 'Evaluate the 2016 event and create a proposal for the 2017 by November 30, 2016.', 
                'priority' => 2, 'due_date' => Carbon\Carbon::now() , 'budget' => 0, 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()),
    		
            array('type' => 'A', 'parent_id' => 7, 
                'description' => 'Obtain $10,000 in shared cost partnerships for 2016 events.', 
                'priority' => 1, 'due_date' => Carbon\Carbon::now() , 'budget' => 0, 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()),
